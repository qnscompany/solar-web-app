...
export const metadata: Metadata = {
  ...
  description: '충남 당진 주민이 만든 우리 동네 태양광 비교 서비스. 에너지공단 인증 업체 엄선, 무료 견적 비교, 사후 관리 보증까지 한눈에 확인하세요.',
  openGraph: {
    title: '쨍하고 | 충남 1위 태양광 시공업체 무료 비교',
    description: '사기 걱정 없는 우리 동네 태양광 시공. 직접 발로 뛰어 검증한 충남 업체들의 견적을 30초 만에 비교해 드립니다.',
  ...
  twitter: {
    ...
    title: '쨍하고 | 충남 태양광 시공업체 비교',
    description: '충남 주민이 직접 검증한 태양광 업체들을 무료로 비교하세요.',
  },
